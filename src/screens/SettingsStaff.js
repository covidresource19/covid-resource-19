...
export default class SettingsStaff extends React.Component {
        ...
        return(
            <View style = {{flex: 1}}>
                ...
                <View style = {{marginTop: 20, margin: 10}}>
                    <TouchableOpacity
                    onPress = {() => this.props.navigation.navigate('CheckWardStaff')}
                    >
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => this.props.navigation.navigate('currentStaff')}
                    >
